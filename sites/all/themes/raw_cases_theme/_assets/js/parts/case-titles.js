(function ($) {
  ...
  $('.case-tiles .tile').each(function () {
    ...
    if (tile.hasClass('small') && tile.find('img').attr('src') == '') {
      $(this).find('img').attr('src', '/sites/all/themes/raw_cases_theme/_assets/images/blank-s.gif');
    } else if (tile.hasClass('medium') && tile.find('img').attr('src') == '') {
      $(this).find('img').attr('src', '/sites/all/themes/raw_cases_theme/_assets/images/blank-m.gif');
    } else if (tile.hasClass('large') && tile.find('img').attr('src') == '') {
      $(this).find('img').attr('src', '/sites/all/themes/raw_cases_theme/_assets/images/blank-l.gif');
    } else if (tile.hasClass('xlarge') && tile.find('img').attr('src') == '') {
      $(this).find('img').attr('src', '/sites/all/themes/raw_cases_theme/_assets/images/blank-xl.gif');
    }
  ...
  $('.document-tiles .tile').each(function () {
    var tile = $(this);
    if (tile.find('img').attr('src') == '') {
      tile.addClass('no-img').find('img').attr('src', '/sites/all/themes/raw_cases_theme/_assets/images/blank-sq.gif');
    }
  });
