...
function _raw_cases_theme_load($files) {
  $tp = drupal_get_path('theme', 'raw_cases_theme');
  $file = '';
...
function raw_cases_theme_theme(&$existing, $type, $theme, $path) {
   $hooks['user_login_block'] = array(
    ...
    'render element' => 'form',
    'path' => drupal_get_path('theme', 'raw_cases_theme') . '/templates',
    'template' => 'user-login',
    'preprocess functions' => array(
    'raw_cases_theme_preprocess_user_login'
    ),
   );
   return $hooks;
 }

function raw_cases_theme_preprocess_user_login_block(&$vars) {
 ...
 */
function raw_cases_theme_html_head_alter(&$head_elements) {
 ...
 */
function raw_cases_theme_breadcrumb($variables) {
...
function raw_cases_theme_field($variables) {
  $output = '';
 ...
 */
function raw_cases_theme_field__taxonomy_term_reference($variables) {
  $output = '';
 ...
 */
function raw_cases_theme_preprocess_block(&$variables) {
 ...
 */
function raw_cases_theme_preprocess_field(&$variables) {
 ...
 */
function raw_cases_theme_preprocess_html(&$variables) {
  global $language;
...
function raw_cases_theme_process_html(&$vars) {
 ...
 */
function raw_cases_theme_preprocess_node(&$variables) {
 ...
 */
function raw_cases_theme_preprocess_page(&$variables) {
 ...
 *
 */
function raw_cases_theme_preprocess_panels_pane(&$variables) {
}
 ...
 */
function raw_cases_theme_preprocess_views_view(&$variables) {
 ...
 */
function raw_cases_theme_css_alter(&$css) {
 ...
 */
function raw_cases_theme_js_alter(&$js) {
 ...
 */
function raw_cases_theme_preprocess_book_navigation(&$variables) {
